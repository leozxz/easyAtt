...
class Cart(models.Model):
    usuario = models.ForeignKey(Tb_usuario, on_delete=models.DO_NOTHING,)
    cliente = models.ForeignKey(Tb_cliente, on_delete=models.DO_NOTHING,)
    produto = models.ForeignKey(Tb_estoque, on_delete=models.DO_NOTHING,)
    tamanhoCHOICES = [
        ('PP', 'PP'),
        ('P', 'P'),
        ('M', 'M'),
    ...
    newV = models.DecimalField(decimal_places=2, max_digits=15, verbose_name='Preco da venda', null=True)
